...
Put simply, the Breusch-Pagan test is a right-sided where the test statistic is $\tau \sim \chi_v^2$ with $v = 1$ degrees of freedom. $v$ equals the number of regressors used in the residual regression.
