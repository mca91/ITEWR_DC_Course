...
```{r}
msg_bad <- "That is not correct!"
msg_success <- "Wow! You're doin' good! The fit of the blue regression line fits the data much better. Hence, excluding the intercept is not a good idea in this case."
test_mc(correct = 2, feedback_msgs = c(msg_bad, msg_success, msg_bad, msg_bad))
```

--- type:MultipleChoiceExercise lang:r xp: skills: key:426e06a731
## What Was R^2 Again?  
...
- We cannot reject the hypothsis at the $0.05$ level of significant since $p\text{-value} > 0.05$.
- The value of the $t$-statistic is an element of the set of values for which the null would be rejected.
